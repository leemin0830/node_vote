...
(function() {
	var timer = setInterval(function() {
		...
		//DeviceInfo, NavigationInfo, PreferenceInfo는 device ready event 발생의 전제 조건임.
...
Http.prototype.download = function(entity, successCallback, errorCallback, progressCallback, cancelCallback) {
	if(isValid(entity) && isValid(successCallback) && isValid(errorCallback) && isValid(progressCallback) && isValid(cancelCallback)){
		if(typeof(successCallback) == "function" && typeof(errorCallback) == "function" && typeof(progressCallback) == "function" && typeof(cancelCallback) == "function")
			Alopex.exec("HttpJSNI.download", this.index, JSON.stringify(entity), GetFunctionName(successCallback), GetFunctionName(errorCallback), GetFunctionName(progressCallback),GetFunctionName(cancelCallback));
...
Http.prototype.upload = function(entity, successCallback, errorCallback, progressCallback, cancelCallback) {
	if(isValid(entity) && isValid(successCallback) && isValid(errorCallback) && isValid(progressCallback) && isValid(cancelCallback)){
		if(typeof(successCallback) == "function" && typeof(errorCallback) == "function" && typeof(progressCallback) == "function" && typeof(cancelCallback) == "function")
			Alopex.exec("HttpJSNI.upload", this.index, JSON.stringify(entity), GetFunctionName(successCallback), GetFunctionName(errorCallback), GetFunctionName(progressCallback),GetFunctionName(cancelCallback));
		else if(typeof(successCallback) == "string" && typeof(errorCallback) == "string" && typeof(progressCallback) == "string" && typeof(cancelCallback) == "string")
...
Log.prototype.error = function(message) {
	if(isValid(message)) {
		...
		if(Alopex.available)
			Alopex.exec("LogJSNI.error", message, {logLevel: "ERROR"});
	}
};
...
Log.prototype.log = function(message) {
	if(isValid(message)) {
		...
		if(Alopex.available)
			Alopex.exec("LogJSNI.log", message, {logLevel: "INFO"});
	}
};
...
Log.prototype.warn = function(message) {
	if(isValid(message)) {
		...
		if(Alopex.available)
			Alopex.exec("LogJSNI.warn", message, {logLevel: "WARN"});
	}
};
...
Sensor.prototype.startAccelerometerSensor = function(successCallback, errorCallback, interval){
	if(isValid(successCallback) && isValid(errorCallback))
		Alopex.exec("DeviceSensorJSNI.startAccelerometerSensor", GetFunctionName(successCallback), GetFunctionName(errorCallback) , interval);
};
...
Sensor.prototype.startCompassSensor = function(successCallback, errorCallback, interval){
	if(isValid(successCallback) && isValid(errorCallback))
		Alopex.exec("DeviceSensorJSNI.startCompassSensor", GetFunctionName(successCallback), GetFunctionName(errorCallback) , interval);
};
